...
```{python}
user_active = pd.read_csv('./t1_user_active_min.csv')
...
treatment_group_kpi1.to_csv('./post_treatment_kpi1.csv', index = False)
control_group_kpi1['avg_active_mins'].to_csv('./control_kpi1.csv', index = False)
treatment_group_kpi1['avg_active_mins'].to_csv('./treatment_kpi1.csv', index = False)
...
control_group_kpi2['active_mins'].to_csv('./control_kpi2.csv', index = False)
treatment_group_kpi2['active_mins'].to_csv('./treatment_kpi2.csv', index = False)
```
...
```
```{r}
control1 <- read.csv('./control_kpi1.csv')
treatment1 <- read.csv('./treatment_kpi1.csv')

control2 <- read.csv('./control_kpi2.csv')
treatment2 <- read.csv('./treatment_kpi2.csv')
...
```{python}
treatment_kpi1 = pd.read_csv('./post_treatment_kpi1.csv')
treatment_kpi1
all_kpi1 = pd.read_csv('./pre_all_kpi1.csv')
all_kpi1
...
treatment_group_w_pre_post_mins[['avg_active_mins_pre', 'avg_active_mins_post']].to_csv('pre_post_treatment_kp1.csv', index = False)
```

```{r}
library(MASS)
pre_post_treatment <- read.csv('./pre_post_treatment_kp1.csv')
# cov(pre_post_treatment)
mu0 <- c(5,6)
nu0 = 4 # vague prior belief
lambda0 <- matrix(c(16, 12.8, 12.8, 16), byrow = T, nrow = 2)
s0 <- lambda0
# s0_inv = solve(s0)
